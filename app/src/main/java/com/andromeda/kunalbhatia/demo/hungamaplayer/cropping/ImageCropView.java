...
package com.andromeda.kunalbhatia.demo.hungamaplayer.cropping;
...
import com.andromeda.kunalbhatia.demo.hungamaplayer.FastBitmapDrawable;
import com.andromeda.kunalbhatia.demo.hungamaplayer.R;
import com.andromeda.kunalbhatia.demo.hungamaplayer.data.ViewState;
...
public class ImageCropView extends AppCompatImageView {
    ...
    public InstaCropperCredentials_Model getCroppedImageCredentials() {
        InstaCropperCredentials_Model model = null;
        CropInfo cropInfo = getCropInfo();
        if (cropInfo == null) {
            return null;
        }
        ...
        bitmap = getViewBitmap();
        if (bitmap != null) {
            model = cropInfo.getCroppedImageCredentials(bitmap);
        }
