...
import com.andromeda.kunalbhatia.demo.hungamaplayer.utils.PhotosUriResolver
...
object RealPathUtil {
        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            if (isExternalStorageDocument(uri)) {
             ...
             if (isGooglePhotosUri(uri)) {
                 return PhotosUriResolver.getImagePathFromInputStreamUri(context, uri)
            }
    ...
    private fun isGooglePhotosUri(uri: Uri): Boolean = "com.google.android.apps.photos.contentprovider" == uri.authority
